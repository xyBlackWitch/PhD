...
\section{Reconstruction of $\Lambda$ and $\bar{\Lambda}$}\label{subsec:lambda}
	...
	\subsection*{Results}
		...
		\begin{figure}
			...
			\caption{\propose Mass distribution (black histogram) for \lam fitted with a double Gaussian fit (red dashed line).}
...
\section{Reconstruction of \cascade and \anticascade}
	...
	\subsection*{Results}
		...
		\begin{figure}
			...
			\caption{\propose The plot shows the mass distribution (black histogram) after all cuts. 
...
\section{Reconstruction of \excitedcascade and \excitedanticascade}
	...
	\begin{figure}
		...
		\caption{\propose Mass distribution (black histogram) after all cuts for \excitedcascade. The performed double Gaussian fit is shown as the red dashed line.}
