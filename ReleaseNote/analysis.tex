...
\section{Reconstruction of $\Lambda^0$ and $\bar{\Lambda}^0$}
	...
	\subsection*{Results}
		...
		\begin{figure}
			...
			\caption{\propose Mass distribution of \lam after the mass window cut in blue, after the vertex fit cut in red and after all cuts in black.}
		...
		The reconstructed mass can be determined by performing a double Gaussian fit on mass after all cuts.
		...
		\begin{figure}
			...
			\caption{\propose Figure a) shows the transverse against the longitudinal momentum for \lam. Figure b) hows the same distribution for \alam.}
		...
		\begin{figure}
			...
			\caption{\propose The upper plot shows the decay vertex position of \lam and the lower plot shows the decay vertex position of \alam. 
					...
					The black horizontal and verticle lines mark the borders of the MVD.}
...
\section{Reconstruction of $\Xi$ and $\bar{\Xi}$}
	\subsection*{Selection}
		...
		After combining the daughter particles a mass window cut is performed with width of $0.3$\massunit around 
	...
	\subsection*{Results}
		...
		\begin{figure}
			...
			\caption{\propose The plot shows the mass distributian (blue line) after all cuts. 
		...
		\end{figure}
		The result of the mass fit is for \anticascade ${\mt{m} = \left( 1.321716 \pm 9.2\cdot 10^{-6}\right)}$ \massunit 
		and for \cascade \\ ${\mt{m} = \left( 1.3216474 \pm 9.3\cdot 10^{-6}\right)}$\massunit.
...
\section{Reconstruction of the hole reaction chain}
	...
	For this reconstruction the event selection is done with a exclusive method.
	The resulting four-momentum vector of both daughter particles --  here \excitedcascade 
	and \anticascade and there c.c. particles -- is fitted to the initial for momentum vector  
