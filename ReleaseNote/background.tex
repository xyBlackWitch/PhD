...
\begin{table}
	...
	\begin{tabular}{lccc}
		...
		& & &\\
		%\pbarpSystem $\rightarrow$ \excitedcascade \anticascade & & &\\
		\lam & 786,243 &$ 1.585 \cdot 10^{9}$& 19.74\\
		\alam & 711,820 & $ 744.408 \cdot 10^{6}$ & 26.08\\
		\anticascade & 302,681 & $ 18.372 \cdot 10^{6}$ & 70.04\\
		\excitedcascade &490,672  & $ 1.788 \cdot 10^{6}$& 325.05\\
		\excitedcascade \anticascade &  74,523 & 0 & > 262.62\\
		\hline
...
\begin{equation}
	\nonumber
	\frac{N_\mt{sig}}{N_\mt{bg}} = \frac{74,523} {6000} = 12.42 : 1
\end{equation}
