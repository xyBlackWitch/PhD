...
# Task name
#SBATCH -J Analysis_XiMinus1690

# Run time limit
#SBATCH --time=0:20:00

#Working directory on shared storage
#SBATCH -D /lustre/nyx/panda/jpuetz/data/XiMinus1690_Lambda0_K
...
root -l -b -q -w $scripts"/"prod_ana_Xi1690.C\(\"$outprefix\",$nEvts,$mom\) &> $outprefix"_ana.log"
