...
void select_crazy_tracks(){
	...
	TFile * reco = new TFile("/private/puetz/fairsoft_mar15/pandaroot/mysimulations/test/tracking/test_2pi_100_events_third_run/reco_complete_with_kalman.root", "READ");
	TFile * mc = new TFile("/private/puetz/fairsoft_mar15/pandaroot/mysimulations/test/tracking/test_2pi_100_events_third_run/sim_complete.root", "READ");
