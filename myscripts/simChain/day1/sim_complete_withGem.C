...
void sim_complete_withGem(Int_t nEvents = 100, TString  inputGenerator ="psi2s_Jpsi2pi_Jpsi_mumu.dec", Double_t BeamMomentum = 6.231552, TString prefix = "", TString  SimEngine ="TGeant3")
{
  //-----User Settings:------------------------------------------------------
