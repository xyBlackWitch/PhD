void pidideal_complete()
{
  ...
  //corr->SetVerbose();
//  corr->SetInputBranch("IdealTrack");
//  corr->SetInputIDBranch("IdealTrackID");
  corr->SetInputBranch("IdealGenTrack2");
  corr->SetInputIDBranch("IdealGenTrack2ID");
  corr->SetFlagCut(kFALSE);
