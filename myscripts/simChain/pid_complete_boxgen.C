void pid_complete_boxgen()
{
  ...
  // Parameter file
  TString parFile = "simparams_boxgen.root"; // at the moment you do not need it
  
  // Digitisation file (ascii)
  TString digiFile = "all.par";
  
  // Output file
  TString outFile = "pid_complete_boxgen.root";
  ...
  fRun->SetInputFile("sim_complete_boxgen.root");
  fRun->AddFriend("digi_complete_boxgen.root");
  fRun->AddFriend("reco_complete_boxgen.root");
