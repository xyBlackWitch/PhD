...
sim_complete_old(Int_t nEvents = 100, Float_t mom = 6.231552, TString pre="", TString  SimEngine ="TGeant3")
{
  //-----User Settings:-----------------------------------------------
  ...
  SciT->SetGeometryFileName("SciTil_201601.root");//("SciTil_201504.root");
  fRun->AddModule(SciT);
  //-------------------------  DRC       -----------------
