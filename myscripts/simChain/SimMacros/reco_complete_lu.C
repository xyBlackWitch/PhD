...
void reco_complete_lu()
{
  ...
  // Parameter file
  TString parFile = "XiMinus_simparams.root"; // at the moment you do not need it
  
  // Digitisation file (ascii)
  TString digiFile = "all.par";
  
  // Output file
  TString outFile = "XiMinus_reco_complete.root";
  ...
  fRun->SetInputFile("XiMinus_sim_complete.root");
  fRun->AddFriend("XiMinus_digi_complete.root");
