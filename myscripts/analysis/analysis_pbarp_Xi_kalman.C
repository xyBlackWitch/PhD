...
void analysis_pbarp_Xi_kalman(int nevts=0){
...
//      ntpAntiLambda0->Column("McTint dtag[2] = {0,0};
...
//		}
//		if(dtag[0]==1 && dtag[1]==1) tag=1;ruthMatch", (bool) theAnalysis->McTruthMatch(antiLambda0[j]));
...
//
////      jenny::tagNHits("AntiLambda0_", antiLambda0[j], ntpAntiLambda0);
//
//
//      // do vertex fit
...
//      jenny::tagNHits("XiMinus_", ximinus[j], ntpXiMinus);
...
//      }
      ...
      RhoCandidate * kalmanFitximinus = ximinus[j]->GetFit();
...
//
////        jenny::tagNHits("XiSys_", xiSys[syscand], ntpXiSys);
//
//
