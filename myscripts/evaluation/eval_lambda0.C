...
//	gStyle->SetOptStat(0);
	...
	jenny::CreateDrawAndSaveHistogramDoulbeFit(h_l0_m_masscut2, path+"/plots/", "lambda0_m_masscut2", save, close, false, 0.01,0.1);

	//*** vertex resolution
	TH1D * h_l0_vtxres_x = new TH1D("h_l0_vtxres_x", "resolution for x coordinate of vertex for #Lambda; x-x_{MC}; counts", 500,-1,1.05);
	...
	TH1D * h_l0_vtxres_y = new TH1D("h_l0_vtxres_y", "resolution for y coordinate of vertex for #Lambda; y-y_{MC}; counts", 500,-1,1.05);
	...
	TH1D * h_l0_vtxres_z = new TH1D("h_l0_vtxres_z", "resolution for z coordinate of vertex for #Lambda; z-z_{MC}; counts", 500,-1,1.05);
...
//	gStyle->SetOptStat(0);
	...
	TH1D * h_al0_vtxres_x = new TH1D("h_al0_vtxres_x", "resolution for x coordinate of vertex for #bar{#Lambda}; x-x_{MC}; counts", 500,-1,1.05);
	...
	TH1D * h_al0_vtxres_y = new TH1D("h_al0_vtxres_y", "resolution for y coordinate of vertex for #bar{#Lambda}; y-y_{MC}; counts", 500,-1,1.05);
	...
	TH1D * h_al0_vtxres_z = new TH1D("h_al0_vtxres_z", "resolution for z coordinate of vertex for #bar{#Lambda}; z-z_{MC}; counts", 500,-1,1.05);
