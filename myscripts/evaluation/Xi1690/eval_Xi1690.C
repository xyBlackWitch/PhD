...
void eval_Xi1690(TString prefix="", bool save=kTRUE, bool close=kFALSE){
	...
	if(ntpXiMinus1690!=0X0){
		...
		TH1D * h_xi_m_nocut = new TH1D("h_xi_m_nocut", "Mass distribution for #Xi^{-}(1690); M [GeV/c^{2}]; counts", 500,1.59,1.96);
		ntpXiMinus1690->Project("h_xi_m_nocut", "VtxFit_m", "McTruthMatch");

		TH1D * h_xi_m_vtxcut = new TH1D("h_xi_m_vtxcut", "Mass distribution for #Xi^{-}(1690) with vtxcut; M [GeV/c^{2}]; counts", 500,1.59,1.96);
		...
		TH1D * h_xi_m = new TH1D("h_xi_m", "Mass distribution for #Xi^{-}(1690) with vertex cut and mass cut; M [GeV/c^{2}]; counts", 500,1.7,2);
		ntpXiMinus1690->Project("h_xi_m", "VtxFit_m", "McTruthMatch "+vtxcut);
		jenny::CreateDrawAndSaveHistogramVoigtFit(h_xi_m, prefix+"/plots/", "XiMinus1690_m_masscut", save, close, 1.75, 1.87);
		...
		TH1D * h_axi_m = new TH1D("h_axi_m", "Mass distribution for #bar{#Xi}^{+}(1690) with vertex cut and mass cut; M [GeV/c^{2}]; counts", 500,1.7,2);
		ntpXiPlus1690->Project("h_axi_m", "VtxFit_m", "McTruthMatch "+vtxcut);
		jenny::CreateDrawAndSaveHistogramVoigtFit(h_axi_m, prefix+"/plots/", "XiPlus1690_m_masscut", save, close, 1.75, 1.87);
