...
void eval_final_states_antiparticle(TString path="", bool save=kTRUE, bool close=kFALSE){
	...
	jenny::CreateDrawAndSaveHistogram(h_piplus_costht, path+"/plots/", "piplus_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piplus_MC_costht, path+"/plots/", "piplus_MC_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piplus_number_per_evt, path+"/plots/", "piplus_number_per_evt",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_Al0_costht, path+"/plots/", "piminus_Al0_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_Al0_MC_costht, path+"/plots/", "piminus_Al0_MC_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_Al0_number_per_evt, path+"/plots/", "piminus_Al0_number_per_evt",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_XiPlus_costht, path+"/plots/", "piminus_XiPlus_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_XiPlus_MC_costht, path+"/plots/", "piminus_XiPlus_MC_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_XiPlus_number_per_evt, path+"/plots/", "piminus_XiPlus_number_per_evt",save, close);
