...
void eval_Xi(TString path="", bool save=kTRUE, bool close=kFALSE){
	...
	if(ntpXiMinus!=0X0){
		TH2D * h_xi_pt_vs_pz = new TH2D("h_xi_pt_vs_pz", "Transversal vs. longitudinal momentum for #Xi^{-}; p_{z}/GeV/c; p_{t}/GeV/c", 40,-0.5,3.9,40,0,0.8);
		...
		TH1D * h_xi_m_nocut = new TH1D("h_xi_m_nocut", "Mass distribution for #Xi^{-}; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiMinus->Project("h_xi_m_nocut", "XiMinus_m", "McTruthMatch");

		TH1D * h_xi_m_vtxcut = new TH1D("h_xi_m_vtxcut", "Mass distribution for #Xi^{-} with vtxcut; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiMinus->Project("h_xi_m_vtxcut", "XiMinus_m", "McTruthMatch "+vtxcut);

		TH1D * h_xi_m_masscut = new TH1D("h_xi_m_masscut", "Mass distribution for #Xi^{-} with vertex cut and mass cut; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiMinus->Project("h_xi_m_masscut", "XiMinus_m", "McTruthMatch "+vtxcut+masscut);
		...
		TH1D * h_xi_m_masscut2 = new TH1D("h_xi_m_masscut2", "Mass distribution for #Xi^{-} with vertex cut and mass cut; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiMinus->Project("h_xi_m_masscut2", "XiMinus_m", "McTruthMatch "+vtxcut+masscut);
		jenny::CreateDrawAndSaveHistogramFit(h_xi_m_masscut2, path+"/plots/", "XiMinus_m_masscut2", save, close);

		TH1D * h_xi_vtxres_x = new TH1D("h_xi_vtxres_x", "resolution for x coordinate of vertex for #Xi^{-}; x-x_{MC}; counts", 100,-1,1);
		...
		TH1D * h_xi_vtxres_y = new TH1D("h_xi_vtxres_y", "resolution for y coordinate of vertex for #Xi^{-}; y-y_{MC}; counts", 100,-1,1);
		...
		TH1D * h_xi_vtxres_z = new TH1D("h_xi_vtxres_z", "resolution for z coordinate of vertex for #Xi^{-}; z-z_{MC}; counts", 100,-1,1);
		...
		TH1D * h_xi_costht = new TH1D("h_xi_costht", "cos(#Theta) distribution for #Xi^{-}; cos(#Theta); counts", 100,-1,1);
		...
		TH1D * h_xi_tht = new TH1D("h_xi_tht", "#Theta distribution for #Xi^{-}; #Theta/rad; counts", 100,-1,1);
		...
		TH2D * h_axi_pt_vs_pz = new TH2D("h_axi_pt_vs_pz", "Transversal vs. longitudinal momentum for #bar{#Xi}; p_{z}/GeV/c; p_{t}/GeV/c", 40,0.5,3.1,40,0,0.7);
		...
		gStyle->SetOptStat(0);
		TH1D * h_axi_m_nocut = new TH1D("h_axi_m_nocut", "Mass distribution for #bar{#Xi}; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiPlus->Project("h_axi_m_nocut", "Xiplus_m", "McTruthMatch");

		TH1D * h_axi_m_vtxcut = new TH1D("h_axi_m_vtxcut", "Mass distribution for #bar{#Xi} with vtxcut; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiPlus->Project("h_axi_m_vtxcut", "Xiplus_m", "McTruthMatch "+vtxcut);

		TH1D * h_axi_m_masscut = new TH1D("h_axi_m_masscut", "Mass distribution for #bar{#Xi} with vertex cut and mass cut; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiPlus->Project("h_axi_m_masscut", "Xiplus_m", "McTruthMatch "+vtxcut+masscut);
		...
		TH1D * h_axi_m_masscut2 = new TH1D("h_axi_m_masscut2", "Mass distribution for #bar{#Xi} with vertex cut and mass cut; m/GeV/c^{2}; counts", 100,1.1,1.5);
		ntpXiPlus->Project("h_axi_m_masscut2", "Xiplus_m", "McTruthMatch "+vtxcut+masscut);
		jenny::CreateDrawAndSaveHistogramFit(h_axi_m_masscut2, path+"/plots/", "XiPlus_m_masscut", save, close);

		TH1D * h_axi_vtxres_x = new TH1D("h_axi_vtxres_x", "resolution for x coordinate of vertex for #bar{#Xi}; x-x_{MC}; counts", 100,-1,1);
		...
		TH1D * h_axi_vtxres_y = new TH1D("h_axi_vtxres_y", "resolution for y coordinate of vertex for #bar{#Xi}; y-y_{MC}; counts", 100,-1,1);
		...
		TH1D * h_axi_vtxres_z = new TH1D("h_axi_vtxres_z", "resolution for z coordinate of vertex for #bar{#Xi}; z-z_{MC}; counts", 100,-1,1);
		...
		TH1D * h_axi_costht = new TH1D("h_axi_costht", "cos(#Theta) distribution for #bar{#Xi}; cos(#Theta); counts", 100,-1,1);
		...
		TH1D * h_axi_tht = new TH1D("h_axi_tht", "#Theta distribution for #bar{#Xi}; #Theta/rad; counts", 100,-1,1);
