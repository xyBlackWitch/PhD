...
//		jenny::CreateDrawAndSaveNHistograms(h_xi_m_nocut, h_xi_m_vtxcut, "mass window", "VtxFit_prob>0.01", path+"/plots/", "XiMinus1820_m_diffcuts", save, close);
		...
		jenny::CreateDrawAndSaveHistogramDoulbeFit(h_xi_m, path+"/plots/", "XiMinus1820_m_masscut", save, close,false, 0.01,0.1);
...
//		jenny::CreateDrawAndSaveHistogram(h_xi_chisq, path+"/plots/", "XiMinus1820_chisq", save, close, true);
//
...
//		jenny::CreateDrawAndSaveHistogram(h_xi_prob, path+"/plots/", "XiMinus1820_prob", save, close,true);
		...
		jenny::CreateDrawAndSaveHistogram(h_axi_pt_vs_pz_cut, path+"/plots/", "XiPlus1820_pt_vs_pz_cut", save, close);
		...
		jenny::CreateDrawAndSaveNHistograms(h_axi_m_nocut, h_axi_m_vtxcut, "mass window", "VtxFit_prob>0.01", path+"/plots/", "XiPlus1820_m_diffcuts", save, close);
		...
		jenny::CreateDrawAndSaveHistogramDoulbeFit(h_axi_m, path+"/plots/", "XiPlus1820_m_masscut", save, close, false, 0.01,0.1,true);
		...
		jenny::CreateDrawAndSaveHistogram(h_xi_chisq, path+"/plots/", "XiPlus1820_chisq", save, close, true);
