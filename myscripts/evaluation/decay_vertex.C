...
void decay_vertex(TString pre="", bool save=true, bool close=false){
	...
	TH2D * h_lambda0_vtx = new TH2D("h_lambda0_vtx", "decay vertex of #Lambda^{0}; v_{z}/cm; R/cm", 200, 0,30, 200, 0,30);
	...
	TH2D * h_antiLambda0_vtx = new TH2D("h_antiLambda0_vtx", "decay vertex of #bar{#Lambda}^{0}; v_{z}/cm; R/cm", 200, 0,30, 200, 0,30);
