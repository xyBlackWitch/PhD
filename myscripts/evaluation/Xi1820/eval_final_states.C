...
void eval_final_states(TString prefix="", bool save=kTRUE, bool close=kFALSE){
...
//	else prefix = pre;
	...
	TH2D * h_pimius_pt_vs_pz = new TH2D("h_piminus_pt_vs_pz", "Transverse vs. longitudinal momentum for #pi^{-}; pz/GeV/c; pt/GeV/c", 200,-1,2.5, 200,0,1);
	ntpPiMinus->Project("h_piminus_pt_vs_pz", "piminus_MC_pt: piminus_MC_pz", "McTruthMatch && piminus_HitTag && Mother==3122");
	jenny::CreateDrawAndSaveHistogram(h_piminus_pt_vs_pz, prefix+"/plots/", "piminus_pt_vs_pz",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_costht, prefix+"/plots/", "piminus_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_MC_costht, prefix+"/plots/", "piminus_MC_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piminus_number_per_evt, prefix+"/plots/", "piminus_number_per_evt",save, close);


	//**** Get information about pi+(AntiLambda0) ********************************************************************


	TH2D * h_piplus_Al0_pt_vs_pz = new TH2D("h_piplus_Al0_pt_vs_pz", "Transverse vs. longitudinal momentum for #pi^{+}(#bar{#Lambda}^{0}); pz/GeV/c; pt/GeV/c", 200,-0.1,0.7, 200,0,0.2);
	ntpPiPlus->Project("h_piplus_Al0_pt_vs_pz", "piplus_MC_pt: piplus_MC_pz", "McTruthMatch && piplus_HitTag && Mother==-3122");
	jenny::CreateDrawAndSaveHistogram(h_piplus_Al0_pt_vs_pz, prefix+"/plots/", "piplus_Al0_pt_vs_pz",save, close);


	TH1D * h_piplus_Al0_costht = new TH1D("h_piplus_Al0_costht", "cos(#Theta) distribution for #pi^{+}(#bar{#Lambda}^{0}); cos(#Theta); counts", 200, -1,1.05);
	ntpPiPlus->Project("h_piplus_Al0_costht", "cos(piplus_tht)", "McTruthMatch && piplus_HitTag && Mother==-3122");
	jenny::CreateDrawAndSaveHistogram(h_piplus_Al0_costht, prefix+"/plots/", "piplus_Al0_costht",save, close);

	TH1D * h_piplus_Al0_MC_costht = new TH1D("h_piplus_Al0_MC_costht", "generated cos(#Theta) distribution for #pi^{+}(#bar{#Lambda}^{0}); cos(#Theta); counts", 200, -1,1.05);
	ntpPiPlus->Project("h_piplus_Al0_MC_costht", "piplus_MC_CosTheta", "McTruthMatch && piplus_HitTag && Mother==-3122");
	jenny::CreateDrawAndSaveHistogram(h_piplus_Al0_MC_costht, prefix+"/plots/", "piplus_Al0_MC_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piplus_Al0_number_per_evt, prefix+"/plots/", "piplus_Al0_number_per_evt",save, close);
	...
	TH2D * h_piplus_XiPlus_pt_vs_pz = new TH2D("h_piplus_XiPlus_pt_vs_pz", "Transverse vs. longitudinal momentum for #pi^{+}(#bar{#Xi}); pz/GeV/c; pt/GeV/c", 200,-0.1,1, 200,0,0.3);
	ntpPiPlus->Project("h_piplus_XiPlus_pt_vs_pz", "piplus_MC_pt: piplus_MC_pz", "McTruthMatch && piplus_HitTag && Mother==-3312");
	jenny::CreateDrawAndSaveHistogram(h_piplus_XiPlus_pt_vs_pz, prefix+"/plots/", "piplus_XiPlus_pt_vs_pz",save, close);


	TH1D * h_piplus_XiPlus_costht = new TH1D("h_piplus_XiPlus_costht", "cos(#Theta) distribution for #pi^{+}(#bar{#Xi}); cos(#Theta); counts", 200, -1,1.05);
	ntpPiPlus->Project("h_piplus_XiPlus_costht", "cos(piplus_tht)", "McTruthMatch && piplus_HitTag && Mother==-3312");
	jenny::CreateDrawAndSaveHistogram(h_piplus_XiPlus_costht, prefix+"/plots/", "piplus_XiPlus_costht",save, close);

	TH1D * h_piplus_XiPlus_MC_costht = new TH1D("h_piplus_XiPlus_MC_costht", "generated cos(#Theta) distribution for #pi^{+}(#bar{#Xi}); cos(#Theta); counts", 200, -1,1.05);
	ntpPiPlus->Project("h_piplus_XiPlus_MC_costht", "piplus_MC_CosTheta", "McTruthMatch && piplus_HitTag && Mother==-3312");
	jenny::CreateDrawAndSaveHistogram(h_piplus_XiPlus_MC_costht, prefix+"/plots/", "piplus_XiPlus_MC_costht",save, close);
	...
	jenny::CreateDrawAndSaveHistogram(h_piplus_XiPlus_number_per_evt, prefix+"/plots/", "piplus_XiPlus_number_per_evt",save, close);
