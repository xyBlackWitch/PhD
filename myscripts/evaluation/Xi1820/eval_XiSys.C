...
void eval_XiSys(TString prefix="", bool save=kTRUE, bool close=kFALSE){
	...
	TH2D * h_xi_pt_vs_pz = new TH2D("h_xi_pt_vs_pz", "Transverse vs. longitudinal momentum for #Xi^{-}(1820)#bar{#Xi}^{+}-System; p_{z}/GeV/c; p_{t}/GeV/c", 200,-5,5,200,-5,5);
	...
	TH1D * h_xi_m_nocut = new TH1D("h_xi_m_nocut", "Mass distribution for #Xi^{-}(1820)#bar{#Xi}^{+}-System; m/GeV/c^{2}; counts", 500,3.2,3.3);
	ntpXiSys->Project("h_xi_m_nocut", "4cFit_m", "McTruthMatch");

	TH1D * h_xi_m_cut = new TH1D("h_xi_m_cut", "Mass distribution for #Xi^{-}(1820)#bar{#Xi}^{+}-System with cut; m/GeV/c^{2}; counts", 500,3.2,3.3);
...
//	TH1D * h_xi_m_masscut2 = new TH1D("h_xi_m_masscut2", "Mass distribution for #Xi^{-}(1820)#bar{#Xi}^{+}-System with 4C-Fit cut; m/GeV/c^{2}; counts", 500,3.2,3.3);
...
//
	...
	TH1D * h_xi_vtxres_x = new TH1D("h_xi_vtxres_x", "resolution for x coordinate of vertex for #Xi^{-}(1820)#bar{#Xi}^{+}-System; x-x_{MC}; counts", 500,-0.02,0.02);
	...
	TH1D * h_xi_vtxres_y = new TH1D("h_xi_vtxres_y", "resolution for y coordinate of vertex for #Xi^{-}(1820)#bar{#Xi}^{+}-System; y-y_{MC}; counts", 500,-0.02,0.02);
	...
	TH1D * h_xi_vtxres_z = new TH1D("h_xi_vtxres_z", "resolution for z coordinate of vertex for #Xi^{-}(1820)#bar{#Xi}^{+}-System; z-z_{MC}; counts", 500,-0.02,0.02);
	...
	TH1D * h_xi_costht = new TH1D("h_xi_costht", "cos(#Theta) distribution for #Xi^{-}(1820)#bar{#Xi}^{+}-System; cos(#Theta); counts", 500,-1,1.01);
	...
	TH1D * h_xi_tht = new TH1D("h_xi_tht", "#Theta distribution for #Xi^{-}(1820)#bar{#Xi}^{+}-System; #Theta/rad; counts", 500,-0.5,3);
	...
	TH1D * h_xi_chisq = new TH1D("h_xi_chisq", "#chi^{2} distribution for #Xi^{-}(1820)#bar{#Xi}^{+}-System; #chi^{2}; counts", 500,0,100);
	...
	TH1D * h_xi_prob = new TH1D("h_xi_prob", "probability distribution for #Xi^{-}(1820)#bar{#Xi}^{+}-System; prob; counts", 500,0,1);
